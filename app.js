...
//Crea una función que muestre en la consola todos los elementos de la lista "lenguagesDeProgramacion en orden 
//inverso.
function mostrarLenguajesSeparadamente() {
    for (let i = lenguagesDeProgramacion.length - 1; i--) {
        console.log(lenguajesDeProgramacion[i]);
    }
}
